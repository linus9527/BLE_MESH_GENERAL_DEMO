...
- `PH_Node`：通过 XIAO-RS485 扩展板读取 MIK-PH-8001，每 5 秒上报温度、pH 和 pH 毫伏值，并支持远程校准。
- `DO_Node`：通过 XIAO-RS485 扩展板读取 MIK-DO-7019，每 5 秒上报溶解氧、温度、饱和度和校准状态。
- `ORP_Node`：通过 XIAO-RS485 扩展板读取 MIK-ORP-8001，每 5 秒上报温度、ORP 和 ORP 漂移值。
